...
class login:
    ...
    def login_function(self):
        ...
        elif self.txt_user.get()!="Mahtab"or self.txt_pass.get()!="12345":
...
class IMS:
    def __init__(self,root):
        ...
        Leftmenu.place(x=0,y=100,width=200,relheight=1)
        lbl_menuLogo=Label(Leftmenu,image=self.MenuLogo)
        lbl_menuLogo.pack(side=TOP,fill=X)
        lbl_menu=Label(Leftmenu,text="Menu",font=("times new roman",20),bg="purple",fg='white').pack(side=TOP,fill=X)
        lbl_addProduct=Button(Leftmenu,text="Add product",command=add_product,compound=LEFT,font=("times new roman",20),bg="black",fg="white",bd='3',cursor="hand2").pack(side=TOP,fill=BOTH)
        lbl_saleProduct=Button(Leftmenu,text="Sale Product",command=Sale_Product,compound=LEFT,font=("times new roman",20),bg="black",fg="white",bd='2',cursor="hand2").pack(side=TOP,fill=BOTH)
        lbl_Update=Button(Leftmenu,text="Update product",command=update_product,compound=LEFT,font=("times new roman",20),bg="black",fg="white",bd='2',cursor="hand2").pack(side=TOP,fill=BOTH)
        lbl_Search=Button(Leftmenu,text="Search Product",command=SearchProduct,compound=LEFT,font=("times new roman",20),bg="black",fg="white",bd='2',cursor="hand2").pack(side=TOP,fill=BOTH)
        lbl_delete=Button(Leftmenu,text="Delete Product",command=ProductDelete,compound=LEFT,font=("times new roman",20),bg="black",fg="white",bd='2',cursor="hand2").pack(side=TOP,fill=BOTH)
        lbl_exit=Button(Leftmenu,text="Exit",command=exit,compound=LEFT,font=("times new roman",20),bg="black",fg="white",bd='3',cursor="hand2").pack(side=TOP,fill=BOTH)
        
    
        global product_table
        Dataframe=Frame(bd=5,relief=RIDGE,bg="black")
        Dataframe.place(x=200,y=100,relwidth=1,relheight=1)
        MidViewForm =LabelFrame(Dataframe,relief=RIDGE,font=("times new roman",12,"bold"))
        MidViewForm.place(x=0,y=0,relwidth=1,relheight=1,bordermode=INSIDE)
        ...
        lbl_footer=Label(self.root,text="IMS- Inventory Management System | Developed by Mahtab Alam",font=("times new roman",12),bg="#4d636d",fg="white")
        lbl_footer.pack(side=BOTTOM,fill=BOTH,ipady=15)
        self.date_time()
